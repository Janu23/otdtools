    ...
    class Ocupacao{
       ...
       public function __isset($name){
        ...
        public function insert(){
            $sql = "INSERT INTO ocupacao(codFicha, nome, km, sentido, status) VALUES (:codFicha, :nome, :km, :sentido, :status)";
        ...
        public function update(){
            $sql = "UPDATE ocupacao SET codFicha = :codFicha, nome = :nome, km = :km, sentido = :sentido, status = :status WHERE id = :id ";
            $consulta = Conexao::prepare($sql);
        ...
        public function updateParam($id = null, $coluna = null, $status = null){
            $sql = "UPDATE ocupacao SET {$coluna} = :status WHERE id = :id ";
            $consulta = Conexao::prepare($sql);
        ...
        public function delete($id = null){
            $sql =  "DELETE FROM ocupacao WHERE id = :id";
            $consulta = Conexao::prepare($sql);
            $consulta->bindValue('id',$id);
            return $consulta->execute();
        }
        ...
        public function find($id = null){
            $sql =  "SELECT * FROM ocupacao WHERE id = :id";
            $consulta = Conexao::prepare($sql);
            $consulta->bindValue('id',$id);
            $consulta->execute();
        ...
        public function count(){
            $sql = "SELECT COUNT(*) AS linhas FROM ocupacao";
            $consulta = Conexao::prepare($sql);
            $consulta->execute();
            return $consulta->fetch();
        }
        ...
        public function salvarFoto($id, $nome, $data, $observacao = null){
            $sql = "INSERT INTO fotos_ocupacao(codFicha, nome, data, observacao) VALUES (:codFicha, :nome, :data, :observacao)";
            $consulta = Conexao::prepare($sql);
